...
urlpatterns = [
    path('update/<int:id>/', UpdateWithId.as_view(model=Hobbie), name='update'),
    path('add/', Add.as_view(model=Hobbie), name='add'),
    path('delete/<int:id>/', Delete.as_view(model=Hobbie), name='delete'),
